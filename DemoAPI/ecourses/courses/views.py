...
class LessonViewSet(viewsets.ModelViewSet):
    ...
    # /lessons/{pk}/hide_lesson api that hide the lesson
    @swagger_auto_schema(
        operation_description='This API is used to Add tags to a lesson',
        responses={
            status.HTTP_200_OK: LessonSerializer()
        }
    )
    @action(methods=['post'], detail=True,
            url_path="hide_lesson", url_name="hide_lesson")
